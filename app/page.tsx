          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-6 pt-8 text-foreground/70">
              <div className="flex gap-6">
                <a href="https://www.linkedin.com/in/disaraphael/" target="_blank" className="hover:text-primary transition">
                ...
                <a href="https://www.github.com/raphaelbdias" target="_blank" className="hover:text-primary transition">
